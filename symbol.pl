...
%
% noise:       Noise terminal. These are ignored by the parser.
% Comments and whitespace are considered 'noise'.
%
% eof:         End Character - End of File.
% This symbol is used to represent the end of the file
% or the end of the source input.
%
% group_start: Lexical group start.
%
% group_end:   Lexical group end. Groups can end with normal terminals
% as well.
%
% decremented: This was used in the CGT file format. It is not used in
% EGT.
%
% error: Error Terminal. If the parser encounters an error reading a
